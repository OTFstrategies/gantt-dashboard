...
export declare type BryntumSchedulerProBaseProps = {
    ...
    onAfterEventDragSelect?: ((event: {
        source: SchedulerBase;
    }) => void) | string;
    ...
    onBeforeEventAdd?: ((event: {
        source: Scheduler;
        eventRecord: SchedulerEventModel;
        resourceRecords: SchedulerResourceModel[];
        assignmentRecords: SchedulerAssignmentModel[];
    }) => Promise<boolean> | boolean | void) | string;
    ...
    onBeforeEventSegmentDrag?: ((event: {
        source: Scheduler;
        eventRecords: SchedulerEventModel[];
        event: MouseEvent;
    }) => Promise<boolean> | boolean | void) | string;
    onBeforeEventSegmentDropFinalize?: ((event: {
        source: Scheduler;
        context: {
            async: boolean;
            eventRecords: SchedulerEventModel[];
    ...
    onBeforeSelectedContextsShow?: ((event: {
        source: ScheduleContext;
        selectedContexts: TimelineContext[];
        domConfig: DomConfig;
    }) => Promise<boolean> | boolean | void) | string;
    ...
    onEventSegmentDragAbort?: ((event: {
        source: Scheduler;
        eventRecords: SchedulerEventModel[];
    }) => void) | string;
    onEventSegmentDragReset?: ((event: {
        source: Scheduler;
    }) => void) | string;
    onEventSegmentDragStart?: ((event: {
        source: Scheduler;
        eventRecords: SchedulerEventModel[];
        event: MouseEvent;
    }) => void) | string;
    onEventSegmentDrop?: ((event: {
        source: Scheduler;
        eventRecords: SchedulerEventModel[];
    }) => void) | string;
    ...
    onPasteNotAllowed?: ((event: {
        ...
        eventRecords: SchedulerEventModel[];
        assignmentRecords: SchedulerAssignmentModel[];
        originalEventRecords: SchedulerEventModel[];
        originalAssignmentRecords: SchedulerAssignmentModel[];
        date: Date;
        resourceRecord: SchedulerResourceModel;
        isCut: boolean;
        entityName: string;
    ...
    onResourceEditBeforeSave?: ((event: {
        source: ResourceEditor;
        resource: SchedulerProResourceModel;
    }) => Promise<boolean> | boolean | void) | string;
    onResourceEditRemove?: ((event: {
        source: ResourceEditor;
        resource: SchedulerProResourceModel;
    }) => void) | string;
    onResourceEditSave?: ((event: {
        source: ResourceEditor;
        resource: SchedulerProResourceModel;
...
export declare class BryntumSchedulerProBase extends React.Component<BryntumSchedulerProBaseProps> {
    static instanceClass: typeof SchedulerProBase;
