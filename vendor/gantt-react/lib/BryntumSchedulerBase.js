...
import { SchedulerBase } from '@bryntum/gantt';
import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';
export class BryntumSchedulerBase extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumSchedulerBase.instanceName = 'SchedulerBase';
BryntumSchedulerBase.isView = true;
BryntumSchedulerBase.featureNames = [
    'aiFilterFeature',
...
BryntumSchedulerBase.configNames = [
    'adopt',
    'allowCreate',
...
BryntumSchedulerBase.propertyConfigNames = [
    'alignSelf',
    'allowDropOnEventBar',
    'allowOverlap',
...
BryntumSchedulerBase.propertyNames = [
    'focusVisible',
    'hasChanges',
    'isEngineReady',
...
//# sourceMappingURL=BryntumSchedulerBase.js.map