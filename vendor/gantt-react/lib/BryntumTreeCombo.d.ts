...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, Store, StoreConfig, TabConfig, TooltipConfig, TreeCombo, TreeComboListeners, Widget } from '@bryntum/gantt';
...
export declare class BryntumTreeCombo extends React.Component<BryntumTreeComboProps> {
    static instanceClass: typeof TreeCombo;
