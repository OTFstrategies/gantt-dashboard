...
export declare type BryntumResourceHistogramProps = {
    ...
    barTooltipTemplate?: (context: {
        ...
        event: Event;
        record: SchedulerProResourceModel;
    }) => string;
    ...
    onGenerateScalePoints?: ((event: {
        source: ResourceHistogram;
        scalePoints: ScalePoint[];
    }) => void) | string;
...
export declare class BryntumResourceHistogram extends React.Component<BryntumResourceHistogramProps> {
    static instanceClass: typeof ResourceHistogram;
