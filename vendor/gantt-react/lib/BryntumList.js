...
export class BryntumList extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumList.instanceName = 'List';
BryntumList.configNames = [
    'activateOnMouseover',
    'adopt',
    'align',
    'allowGroupSelect',
...
BryntumList.propertyConfigNames = [
    'alignSelf',
    'appendTo',
    'callOnFunctions',
...
BryntumList.propertyNames = [
    'anchorSize',
    'focusVisible',
    'parent'
];
//# sourceMappingURL=BryntumList.js.map