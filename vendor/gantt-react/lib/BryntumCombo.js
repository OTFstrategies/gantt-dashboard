...
export class BryntumCombo extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumCombo.instanceClass = Combo;
BryntumCombo.instanceName = 'Combo';
BryntumCombo.configNames = [
    'adopt',
    'align',
    'anchor',
    'ariaDescription',
...
BryntumCombo.propertyConfigNames = [
    'alignSelf',
    'appendTo',
    'badge',
    'callOnFunctions',
...
//# sourceMappingURL=BryntumCombo.js.map