...
export class BryntumSchedulerPro extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumSchedulerPro.configNames = [
    'adopt',
    'allowCreate',
...
BryntumSchedulerPro.propertyConfigNames = [
    'alignSelf',
    'allowDropOnEventBar',
    'allowOverlap',
...
BryntumSchedulerPro.propertyNames = [
    'focusVisible',
    'hasChanges',
    'isEngineReady',
...
//# sourceMappingURL=BryntumSchedulerPro.js.map