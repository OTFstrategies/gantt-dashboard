...
import { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, TabConfig, TextAreaPickerField, TextAreaPickerFieldListeners, TooltipConfig, Widget, WidgetConfig } from '@bryntum/gantt';
...
export declare class BryntumTextAreaPickerField extends React.Component<BryntumTextAreaPickerFieldProps> {
