...
import { SchedulingModePicker } from '@bryntum/gantt';
import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';
export class BryntumSchedulingModePicker extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumSchedulingModePicker.instanceClass = SchedulingModePicker;
BryntumSchedulingModePicker.instanceName = 'SchedulingModePicker';
BryntumSchedulingModePicker.configNames = [
    'adopt',
    'align',
    'allowedModes',
    'anchor',
...
BryntumSchedulingModePicker.propertyConfigNames = [
    'alignSelf',
    'appendTo',
    'badge',
    'callOnFunctions',
...
BryntumSchedulingModePicker.propertyNames = [
    'anchorSize',
    'content',
    'focusVisible',
    'formula',
