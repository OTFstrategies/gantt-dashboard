...
import { AlignSpec, Base, CollectionFilterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FieldFilterPicker, FieldFilterPickerConfig, FieldFilterPickerGroup, Grid, GridFieldFilterPickerGroup, GridFieldFilterPickerGroupListeners, KeyMapConfig, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumGridFieldFilterPickerGroup extends React.Component<BryntumGridFieldFilterPickerGroupProps> {
    static instanceClass: typeof GridFieldFilterPickerGroup;
