...
import { AlignSpec, Base, Checkbox, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, SlideToggle, SlideToggleListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumSlideToggleProps = {
...
export declare class BryntumSlideToggle extends React.Component<BryntumSlideToggleProps> {
