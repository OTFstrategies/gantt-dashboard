...
import { AlignSpec, Base, ContainerItemConfig, Duration, DurationConfig, DurationField, DurationFieldListeners, DurationUnit, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumDurationField extends React.Component<BryntumDurationFieldProps> {
