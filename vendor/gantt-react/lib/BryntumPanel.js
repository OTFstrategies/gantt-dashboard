...
export class BryntumPanel extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumPanel.instanceName = 'Panel';
BryntumPanel.configNames = [
    'adopt',
    'align',
    'anchor',
    'ariaDescription',
...
BryntumPanel.propertyConfigNames = [
    'alignSelf',
    'appendTo',
    'callOnFunctions',
...
//# sourceMappingURL=BryntumPanel.js.map