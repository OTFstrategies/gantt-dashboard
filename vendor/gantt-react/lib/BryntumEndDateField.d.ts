...
import { AlignSpec, Base, ContainerItemConfig, DateField, DatePickerConfig, DurationConfig, EndDateField, EndDateFieldListeners, EventModel, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, SchedulerProProjectModel, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumEndDateField extends React.Component<BryntumEndDateFieldProps> {
    static instanceClass: typeof EndDateField;
