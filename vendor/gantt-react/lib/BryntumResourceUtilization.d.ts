...
export declare type BryntumResourceUtilizationProps = {
    ...
    onBeforeCopyTimelineCells?: ((event: {
        source: ResourceUtilization;
        cells: TimelineContext[];
        data: string;
        isCut: boolean;
    }) => Promise<boolean> | boolean | void) | string;
    ...
    onBeforePasteTimelineCells?: ((event: {
        source: ResourceUtilization;
        clipboardData: string;
        targetCell: TimelineContext;
    }) => Promise<boolean> | boolean | void) | string;
