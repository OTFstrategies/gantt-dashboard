...
export declare class BryntumFieldFilterPicker extends React.Component<BryntumFieldFilterPickerProps> {
    static instanceClass: typeof FieldFilterPicker;
