...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, RateTableField, RateTableFieldListeners, Rectangle, SchedulerProCalendarManagerStore, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumRateTableField extends React.Component<BryntumRateTableFieldProps> {
    static instanceClass: typeof RateTableField;
