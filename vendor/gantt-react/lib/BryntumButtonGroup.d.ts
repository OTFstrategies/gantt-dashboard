...
import { AlignSpec, Base, Button, ButtonConfig, ButtonGroup, ButtonGroupListeners, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumButtonGroupProps = {
...
export declare class BryntumButtonGroup extends React.Component<BryntumButtonGroupProps> {
    static instanceClass: typeof ButtonGroup;
