...
import { CalendarField } from '@bryntum/gantt';
import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';
export class BryntumCalendarField extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumCalendarField.instanceClass = CalendarField;
BryntumCalendarField.instanceName = 'CalendarField';
BryntumCalendarField.configNames = [
    'adopt',
    'align',
    'anchor',
    'ariaDescription',
...
BryntumCalendarField.propertyConfigNames = [
    'alignSelf',
    'appendTo',
    'badge',
    'callOnFunctions',
...
BryntumCalendarField.propertyNames = [
    'anchorSize',
    'content',
    'focusVisible',
    'formula',
...
//# sourceMappingURL=BryntumCalendarField.js.map