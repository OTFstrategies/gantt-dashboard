...
import { AlignSpec, Base, ChipView, ChipViewListeners, Collection, CollectionConfig, DomConfig, KeyMapConfig, List, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumChipView extends React.Component<BryntumChipViewProps> {
