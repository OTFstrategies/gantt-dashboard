...
export class BryntumGantt extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumGantt.instanceClass = Gantt;
BryntumGantt.instanceName = 'Gantt';
BryntumGantt.isView = true;
BryntumGantt.featureNames = [
    'aiFilterFeature',
    'baselinesFeature',
...
BryntumGantt.propertyConfigNames = [
    'alignSelf',
    'allowDropOnEventBar',
...
//# sourceMappingURL=BryntumGantt.js.map