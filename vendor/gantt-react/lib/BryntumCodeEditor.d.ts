...
export declare type BryntumCodeEditorProps = {
...
export declare class BryntumCodeEditor extends React.Component<BryntumCodeEditorProps> {
    static instanceClass: typeof CodeEditor;
