...
import { AlignSpec, Base, ContainerItemConfig, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, TabConfig, TimeField, TimeFieldListeners, TooltipConfig, Widget, WidgetConfig } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumTimeFieldProps = {
...
export declare class BryntumTimeField extends React.Component<BryntumTimeFieldProps> {
