...
import { AlignSpec, Base, Collection, CollectionConfig, DomConfig, GroupBar, GroupBarListeners, KeyMapConfig, List, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumGroupBar extends React.Component<BryntumGroupBarProps> {
    static instanceClass: typeof GroupBar;
