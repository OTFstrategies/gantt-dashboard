...
import { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, Rectangle, TabConfig, TextAreaField, TextAreaFieldListeners, TooltipConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumTextAreaFieldProps = {
...
export declare class BryntumTextAreaField extends React.Component<BryntumTextAreaFieldProps> {
    static instanceClass: typeof TextAreaField;
