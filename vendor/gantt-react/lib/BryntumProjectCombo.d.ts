...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, ProjectCombo, ProjectComboListeners, Rectangle, SchedulerProjectModel, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumProjectCombo extends React.Component<BryntumProjectComboProps> {
    static instanceClass: typeof ProjectCombo;
