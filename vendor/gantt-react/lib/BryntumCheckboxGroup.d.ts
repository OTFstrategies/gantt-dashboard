...
export declare type BryntumCheckboxGroupProps = {
...
export declare class BryntumCheckboxGroup extends React.Component<BryntumCheckboxGroupProps> {
    static instanceClass: typeof CheckboxGroup;
