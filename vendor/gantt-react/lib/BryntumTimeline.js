...
export class BryntumTimeline extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumTimeline.instanceName = 'Timeline';
BryntumTimeline.configNames = [
    'adopt',
    'allowCreate',
...
BryntumTimeline.propertyConfigNames = [
    'alignSelf',
    'allowDropOnEventBar',
    'allowOverlap',
