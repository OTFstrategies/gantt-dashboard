...
import { AlignSpec, Base, CalendarEditorConfig, CalendarField, CalendarFieldListeners, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, EventModel, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, SchedulerProCalendarManagerStore, SchedulerProProjectModel, SchedulerProResourceModel, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumCalendarField extends React.Component<BryntumCalendarFieldProps> {
    static instanceClass: typeof CalendarField;
