...
import { AlignSpec, Base, ChecklistFilterCombo, ChecklistFilterComboListeners, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumChecklistFilterCombo extends React.Component<BryntumChecklistFilterComboProps> {
    static instanceClass: typeof ChecklistFilterCombo;
