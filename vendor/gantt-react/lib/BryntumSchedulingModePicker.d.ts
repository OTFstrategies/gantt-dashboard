...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, SchedulingModePicker, SchedulingModePickerListeners, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumSchedulingModePicker extends React.Component<BryntumSchedulingModePickerProps> {
    static instanceClass: typeof SchedulingModePicker;
