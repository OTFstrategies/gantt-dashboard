...
import { AlignSpec, Base, ConfirmationBar, ConfirmationBarConfig, ContainerItemConfig, DateField, DateFieldConfig, DateRangeField, DateRangeFieldListeners, DateRangePickerConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Model, MultiDatePickerConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumDateRangeField extends React.Component<BryntumDateRangeFieldProps> {
    static instanceClass: typeof DateRangeField;
