...
import { AlignSpec, Base, CalendarPicker, CalendarPickerListeners, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumCalendarPickerProps = {
...
export declare class BryntumCalendarPicker extends React.Component<BryntumCalendarPickerProps> {
    static instanceClass: typeof CalendarPicker;
    ...
    shouldComponentUpdate(nextProps: Readonly<BryntumCalendarPickerProps>, nextState: Readonly<{}>): boolean;
