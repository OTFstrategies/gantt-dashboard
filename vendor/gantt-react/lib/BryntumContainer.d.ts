...
import { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, ContainerListeners, DomConfig, KeyMapConfig, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumContainerProps = {
...
export declare class BryntumContainer extends React.Component<BryntumContainerProps> {
