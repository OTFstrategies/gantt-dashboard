...
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, ResourceTypeField, ResourceTypeFieldListeners, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/gantt';
...
export declare class BryntumResourceTypeField extends React.Component<BryntumResourceTypeFieldProps> {
    static instanceClass: typeof ResourceTypeField;
