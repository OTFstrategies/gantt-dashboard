...
import { AlignSpec, Base, ClickRepeaterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, Model, PagingToolbar, PagingToolbarListeners, Rectangle, Scroller, ScrollerConfig, Store, TabConfig, ToolConfig, Toolbar, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumPagingToolbarProps = {
...
export declare class BryntumPagingToolbar extends React.Component<BryntumPagingToolbarProps> {
