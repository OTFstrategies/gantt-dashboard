...
export class BryntumDateField extends React.Component {
    constructor() {
        super(...arguments);
...
BryntumDateField.instanceName = 'DateField';
BryntumDateField.configNames = [
    'adopt',
    'align',
    'anchor',
    'ariaDescription',
...
BryntumDateField.propertyConfigNames = [
    'alignSelf',
    'appendTo',
    'badge',
    'callOnFunctions',
...
BryntumDateField.propertyNames = [
    'anchorSize',
    'content',
    'focusVisible',
    'formula',
...
//# sourceMappingURL=BryntumDateField.js.map