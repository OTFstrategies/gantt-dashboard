...
import { AlignSpec, Base, ClickRepeaterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolConfig, Toolbar, ToolbarItems, ToolbarListeners, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
import { processWidgetContent } from './WrapperHelper.js';
export declare type BryntumToolbarProps = {
...
export declare class BryntumToolbar extends React.Component<BryntumToolbarProps> {
