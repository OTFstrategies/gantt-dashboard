/**
 * React wrapper for Bryntum ModelCombo
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import React, { RefObject } from 'react';
import { AlignSpec, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, DomConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, ModelCombo, ModelComboListeners, Rectangle, Scroller, Store, StoreConfig, TabConfig, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';

import { createWidget, shouldComponentUpdate, processWidgetContent } from './WrapperHelper.js';

export type BryntumModelComboProps = {
    // Configs
    /**
     * Element (or element id) to adopt as this Widget's encapsulating element. The widget's
     * content will be placed inside this element.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-align)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     * Enable caching of the last retrieved result until the timeout is reached.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-cacheLastResult)
     */
    cacheLastResult? : number|string|Duration|DurationConfig
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-chipView)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-cls)
     */
    cls? : string|object
    /**
     ...
     * `style` block.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-color)
     */
    color? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-container)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-containValues)
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-draggable)
     */
    draggable? : boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-elementAttributes)
     */
    elementAttributes? : Record<string, string|null>
    /**
     * Text to display in the drop down when there are no items in the underlying store.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-emptyText)
     */
    emptyText? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-encodeFilterParams)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-filterOperator)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-hideAnimation)
     */
     ...
     * a field's units.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-hint)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-hintHtml)
     * @param {object} data A data object
     * @param {Core.widget.Field} data.source A reference to the field instance
     * @param {any} data.value The current value of the field
     * @returns {string}
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-inline)
     */
    inline? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-inlinePicker)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-items)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-keyMap)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-keyStrokeChangeDelay)
     */
    keyStrokeChangeDelay? : number
    /**
     * The delay in milliseconds to wait after the last keystroke before filtering the list.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-keyStrokeFilterDelay)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-labelPosition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-labels)
     */
    labels? : object[]
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-listeners)
     */
    listeners? : ModelComboListeners
    /**
     * Template string used to render the list items in the dropdown list
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-listItemTpl)
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-maximizeOnMobile)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-minChars)
     */
    minChars? : number
    /**
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-multiSelect)
     */
    multiSelect? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-name)
     */
    name? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-picker)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-positioned)
     */
    positioned? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-primaryFilter)
     */
     ...
     * are unresponsive.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-readOnly)
     */
    readOnly? : boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-rendition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-rtl)
     */
    rtl? : boolean
    /**
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-tabIndex)
     */
    tabIndex? : number
    /**
     * Text alignment: 'left', 'center' or 'right'. Also accepts direction neutral 'start' and 'end'.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-tooltip)
     */
    tooltip? : string|TooltipConfig|null
    /**
     * How to query the store upon click of the expand trigger. Specify one of these values:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-triggerAction)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-triggers)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-ui)
     */
    ui? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-valueField)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-x)
     */
    x? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#config-y)
     */
    y? : number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#event-catchAll)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#event-clear)
     * @param {object} event Event object
     * @param {Core.widget.Field,any} event.source This Field
     */
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/ModelCombo#event-paint)
     * @param {object} event Event object
...
export class BryntumModelCombo extends React.Component<BryntumModelComboProps> {

    static instanceClass = ModelCombo;

    static instanceName = 'ModelCombo';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumModelComboProps>, nextState: Readonly<{}>): boolean {
        return shouldComponentUpdate(this, nextProps, nextState);
    }

    render(): React.ReactNode {

        const className = `b-react-model-combo-container`;
        return (
