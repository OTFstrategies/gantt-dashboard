...
export type BryntumSchedulerProBaseProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-allowOverlap)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     * Inline assignments, will be loaded into the backing project's AssignmentStore.
     */
    assignments? : SchedulerProAssignmentModel[]|SchedulerProAssignmentModelConfig[]
    /**
     * The optional [AssignmentStore](https://bryntum.com/products/gantt/docs/api/SchedulerPro/data/AssignmentStore), holding assignments between resources and events.
     * Required for multi assignments.
     */
    assignmentStore? : SchedulerProAssignmentStore|AssignmentStoreConfig
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-autoCreate)
     * @param {'click','dblclick'} autoCreate.gesture The gesture to trigger auto creation of an event. Defaults to `dblclick`.
     * @param {boolean} autoCreate.useEventModelDefaults Set to `true` to set default duration based on the defaults specified by the [duration](https://bryntum.com/products/gantt/docs/api/Scheduler/model/EventModel#field-duration) and [durationUnit](https://bryntum.com/products/gantt/docs/api/Scheduler/model/EventModel#field-durationUnit) fields.
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-barMargin)
     */
    barMargin? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-bbar)
     */
    bbar? : (ContainerItemConfig|string)[]|ToolbarConfig|PagingToolbarConfig|null
    /**
     * Custom CSS classes to add to the panel's body element.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-bodyCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-bufferCoef)
     */
    bufferCoef? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-bufferThreshold)
     */
    bufferThreshold? : number
    /**
     * Inline calendars, will be loaded into the backing project's CalendarManagerStore.
     */
    calendars? : SchedulerProCalendarModel[]|CalendarModelConfig[]
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-cls)
     */
    cls? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-collapsible)
     */
     ...
     * `style` block.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-color)
     */
    color? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-columns)
     */
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-cycleResolutionPopupClass)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-data)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-date)
     */
    date? : Date
    /**
     * A [DateHelper](https://bryntum.com/products/gantt/docs/api/Core/helper/DateHelper) format string/function to use to create date output for view descriptions.
     * @param {Date} date The date to format.
     * @returns {string} The formatted date.
     */
    dateFormat? : string|((date: Date) => string)
    /**
     * A string used to separate start and end dates in the [descriptionFormat](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/Describable#config-descriptionFormat).
     */
     ...
     */
    dependencies? : SchedulerProDependencyModel[]|DependencyModelConfig[]
    /**
    ...
    /**
     * The optional [DependencyStore](https://bryntum.com/products/gantt/docs/api/SchedulerPro/data/DependencyStore).
     */
    dependencyStore? : SchedulerProDependencyStore|DependencyStoreConfig
    /**
     * The date format used by the default [descriptionRenderer](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/Describable#config-descriptionRenderer) for rendering the view's description.
     * If this value is `null`, the [dateFormat](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/Describable#config-dateFormat) (and potentially [dateSeparator](#Scheduler/view/mixin/Describable#config-dateSeparator)) will
     * be used.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-descriptionFormat)
     * @param {Date} date The date to format.
     * @returns {string} The formatted date.
     */
     ...
     * [descriptionFormat](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/Describable#config-descriptionFormat).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-descriptionRenderer)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-displayDateFormat)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-dock)
     */
    dock? : 'top'|'bottom'|'left'|'right'|'start'|'end'|'header'|'pre-header'|object
    /**
     * Make this Panel a docked drawer which slides out from one side of the browser viewport by default.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-drawer)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-elementAttributes)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-emptyText)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-enableRecurringEvents)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-enableSticky)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-endDate)
     */
    endDate? : Date|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-eventColor)
     */
    eventColor? : EventColor
    /**
     * This config defines how to handle overlapping events. Valid values are:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-eventLayout)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-eventReleaseThreshold)
     */
     ...
     * template.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-eventRenderer)
    ...
    /**
     * `this` reference for the [eventRenderer](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/SchedulerEventRendering#config-eventRenderer) function
     */
    eventRendererThisObj? : object
    /**
     * Inline events, will be loaded into the backing project's EventStore.
     */
    events? : EventModel[]|object[]|EventModelConfig[]
    /**
     * Configure as `true`, or set property to `true` to disable event selection.
     */
    eventSelectionDisabled? : boolean
    /**
     * The [EventStore](https://bryntum.com/products/gantt/docs/api/SchedulerPro/data/EventStore) holding the events to be rendered into the scheduler.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-eventStyle)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-fillTicks)
     */
    fillTicks? : boolean
    /**
     ...
     * performance.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-fixedRowHeight)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-footer)
     */
    footer? : {
     ...
     * `formula : true`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-formulaProviders)
     */
    formulaProviders? : Record<string, FormulaProviderConfig>
    /**
     * Refresh entire row when a record changes (`true`) or, if possible, only the cells affected (`false`).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-fullRowRefresh)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-getDateConstraints)
    ...
    /**
     * Scheduler overrides Grid's default implementation of [getRowHeight](https://bryntum.com/products/gantt/docs/api/Grid/view/GridBase#config-getRowHeight) to
     * pre-calculate row heights based on events in the rows.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-getRowHeight)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-header)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-hideRowHover)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-infiniteScroll)
     */
    infiniteScroll? : boolean
    /**
     * Maximum duration (in milliseconds) for the initial animation controlled by [useInitialAnimation](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/SchedulerEventRendering#config-useInitialAnimation).
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-inputFieldAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-isEventSelectable)
    ...
    /**
     * See [Keyboard shortcuts](https://bryntum.com/products/gantt/docs/api/Scheduler/view/Scheduler#keyboard-shortcuts) for details
     */
    keyMap? : Record<string, KeyMapConfig>
    /**
     * Convenience setting to use same label placement on all child widgets.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-labelPosition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-listeners)
     */
    listeners? : SchedulerProBaseListeners
    /**
     * *This property is for use when the Scheduler is used as a Calendar view - a `mode`.*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-listRangeMenu)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-loadMaskDefaults)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-loadMaskError)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-managedEventSizing)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-maxTimeAxisUnit)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-milestoneAlign)
     */
     ...
     * are controlled using [milestoneTextPosition](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/SchedulerEventRendering#config-milestoneTextPosition).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-milestoneLayoutMode)
     */
    milestoneLayoutMode? : 'default'|'estimate'|'data'|'measure'
    /**
     * Position of the milestone text:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-milestoneTextPosition)
     */
     ...
     * inserted.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-minHeight)
     */
     ...
     * this minimum size.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-minPackSize)
     */
    minPackSize? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-multiEventSelect)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-narrowEventWidth)
     */
     ...
     * within a resource.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-overlappingEventSorter)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-partner)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-passStartEndParameters)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-preCalculateHeightLimit)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-presets)
     */
    ...
    /**
     * A [ProjectModel](https://bryntum.com/products/gantt/docs/api/SchedulerPro/model/ProjectModel) instance or a config object. The project holds all SchedulerPro data.
     */
    project? : SchedulerProProjectModel|ProjectModelConfig|RefObject<any>
    /**
     * Accepts the following values:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-projectProgressReporting)
     */
     ...
     * `'month'`, `'week'` and `'day'`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-range)
     */
    range? : string|DurationConfig
    /**
     * Configure as `true` to make the scheduler read-only, by disabling any UIs for modifying data.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-readOnly)
     */
    readOnly? : boolean
    /**
     * The confirmation dialog shown when a recurring event is edited.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-recurrenceConfirmationPopup)
     */
     ...
     * `type`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-rendition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-resizable)
     */
    resizable? : boolean|{
        minWidth?: number
        maxWidth?: number
     ...
     * See [ResourceHeader](https://bryntum.com/products/gantt/docs/api/Scheduler/view/ResourceHeader) for more details on available properties.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-resourceColumns)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-resourceImagePath)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-resourceImages)
     */
    resourceImages? : {
        path?: string
        extension?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-resourceMargin)
     */
    resourceMargin? : number|ResourceMarginConfig
    /**
     * Inline resources, will be loaded into the backing project's ResourceStore.
     */
    resources? : SchedulerProResourceModel[]|ResourceModelConfig[]
    /**
     * The [ResourceStore](https://bryntum.com/products/gantt/docs/api/SchedulerPro/data/ResourceStore) holding the resources to be rendered into the scheduler.
     */
    resourceStore? : SchedulerProResourceStore|ResourceStoreConfig
    /**
     * An empty function by default, but provided so that you can override it. This function is called each time
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-resourceTimeRangeRenderer)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-rtl)
     */
    rtl? : boolean
    /**
     * Class implementing the popup resolving *scheduling conflicts* and *calendar misconfigurations*.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-schedulingIssueResolutionPopupClass)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-scrollable)
     */
    ...
    /**
     * Specifies the maximum duration for extending the current [TimeSpan](https://bryntum.com/products/gantt/docs/api/Scheduler/model/TimeSpan) to allow for smooth
     * scrolling to an event.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-scrollExtensionThreshold)
     */
     ...
     * selected.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-selectionMode)
     */
     ...
     * The time range to move by when [next](https://bryntum.com/products/gantt/docs/api/Scheduler/view/SchedulerBase#function-next) or [previous](#Scheduler/view/SchedulerBase#function-previous) is called.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-shiftIncrement)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-showDirty)
     */
    showDirty? : boolean|{
        duringEdit?: boolean
        newRecord?: boolean
    ...
    /**
     * If set to `true` this will show a color field in the [EventEdit](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventEdit) editor and also a
     * picker in the [EventMenu](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventMenu). Both enables the user to choose a color which will be
     * applied to the event bar's background. See EventModel's
     * [eventColor](https://bryntum.com/products/gantt/docs/api/Scheduler/model/mixin/EventModelMixin#field-eventColor) config.
     * config.
     */
    ...
    /**
     * If set to `true` this will show a color field in the [TaskEdit](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/TaskEdit) editor and also a
     * picker in the [EventMenu](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventMenu). Both enables the user to choose a color which will be
     * applied to the event bar's background. See EventModel's
     * [eventColor](https://bryntum.com/products/gantt/docs/api/Scheduler/model/mixin/EventModelMixin#field-eventColor) config.
     * config.
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-snap)
     */
    snap? : boolean
    /**
     ...
     * is enabled.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-snapRelativeToEventStartDate)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-startDate)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-stateful)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-statefulEvents)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-stateId)
     */
    stateId? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-stateProvider)
     */
    stateProvider? : StateProvider
    /**
     * The properties of this settings object controls how grid is restored from state data.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-stateSettings)
     */
    stateSettings? : {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-store)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-strips)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-subGridConfigs)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-syncMask)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-tabBarItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-tbar)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-terminalHideDelay)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-terminalOffset)
     */
    terminalOffset? : number
    /**
     * Delay in ms before showing the terminals when hovering over an event bar.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-terminalShowDelay)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-terminalSize)
     */
    terminalSize? : number|string
    /**
     * The width/height (depending on vertical / horizontal mode) of all the time columns.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-tickSize)
     */
    tickSize? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-timeResolution)
     */
    timeResolution? : {
        increment?: number
        unit?: DurationUnit
     ...
     * information.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-timeZone)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-title)
     */
    title? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-tools)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-ui)
     */
    ui? : 'plain'|'toolbar'|string|object
    /**
     * By default, scrolling the schedule will update the [timelineContext](https://bryntum.com/products/gantt/docs/api/Scheduler/view/SchedulerBase#property-timelineContext) to reflect the new
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-useContextualRecurrenceRules)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-useInitialAnimation)
     */
    useInitialAnimation? : boolean|'fade-in'|'slide-from-left'|'slide-from-top'|string
    /**
     * The time axis column config for vertical [mode](https://bryntum.com/products/gantt/docs/api/Scheduler/view/SchedulerBase#config-mode).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-verticalTimeAxisColumn)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-viewPreset)
     */
    viewPreset? : string|ViewPresetConfig
    /**
     * A date to bring into view initially on the scrollable timeline.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-visibleDate)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#config-workingTime)
     */
    workingTime? : {
        fromDay?: number
        toDay?: number
     ...
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The event record being created
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource record
     ...
     */
    onAfterEventDragSelect? : ((event: { source: SchedulerBase }) => void)|string
    /**
     * Fired on the owning Scheduler after event drop
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.assignmentRecords
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords
     ...
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The record about to be saved
     */
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords Dropped segments
     * @param {boolean} event.valid
     * @param {object} event.context
     */
     ...
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.selected An array of the Assignments added to the selection.
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.deselected An array of the Assignments removed from the selection.
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.selection The new selection.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeAssignmentDelete)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The Scheduler instance
     ...
     * @param {Scheduler.model.SchedulerEventModel[]} event.selected An array of assignments that will be added to the selection.
     * @param {Scheduler.model.SchedulerEventModel[]} event.deselected An array of assignments that will be removed from the selection.
     * @param {Scheduler.model.SchedulerEventModel[]} event.selection The currently selected assignments, before applying `selected` and `deselected`.
     */
    onBeforeAssignmentSelectionChange? : ((event: { action: string, selected: SchedulerEventModel[], deselected: SchedulerEventModel[], selection: SchedulerEventModel[] }) => Promise<boolean>|boolean|void)|string
    /**
     * This event fires whenever the [autoCreate gesture](https://bryntum.com/products/gantt/docs/api/Scheduler/view/SchedulerBase#config-autoCreate) is detected.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeAutoCreate)
     * @param {object} event Event object
     ...
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource if the UI includes a resource.
     */
    onBeforeAutoCreate? : ((event: { domEvent: Event, date: Date, resourceRecord: SchedulerResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeCancelRowEdit)
     * @param {object} event Event object
    ...
    /**
     * This event is fired on the owning Scheduler when the context [element](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScheduleContext#property-element) or
     * [widget](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScheduleContext#property-widget) is about to be shown.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeContextShow)
     * @param {object} event Event object
     ...
     */
    onBeforeContextShow? : ((event: { source: ScheduleContext, context: TimelineContext, element: HTMLElement, position: { width: number, height: number, x: number, y: number } }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeDragCreate)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source
     ...
     */
    onBeforeDragCreate? : ((event: { source: Scheduler, resourceRecord: SchedulerResourceModel, date: Date }) => Promise<boolean>|boolean|void)|string
    /**
     * Fires on the owning Scheduler to allow implementer to prevent immediate finalization by setting
     * `data.context.async = true` in the listener, to show a confirmation popup etc.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeDragCreateFinalize)
     * @param {object} event Event object
     ...
     */
    onBeforeDragCreateFinalize? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, resourceRecord: SchedulerResourceModel, eventElement: HTMLElement, context: { startDate: Date, endDate: Date, async: boolean, finalize: Function } }) => void)|string
    /**
     * Fires before an event is added. Can be triggered by schedule double click or drag create action.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The Scheduler instance
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The record about to be added
     * @param {Scheduler.model.SchedulerResourceModel[]} event.resourceRecords Resources that the record is assigned to
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.assignmentRecords The assignment records
     */
     ...
     * for async vetoing).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventDelete)
     * @param {object} event Event object
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Scheduler instance
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord Event record the drag starts from
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord Resource record the drag starts from
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords Event records being dragged
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.assignmentRecords Assignment records being dragged
     * @param {MouseEvent} event.domEvent Browser event
     */
    onBeforeEventDrag? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, resourceRecord: SchedulerResourceModel, eventRecords: SchedulerEventModel[], assignmentRecords: SchedulerAssignmentModel[], domEvent: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onBeforeEventDragSelect? : ((event: { source: SchedulerBase, event: Event }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventDropFinalize)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Scheduler instance
     * @param {object} event.context
     ...
     * @param {Scheduler.model.SchedulerEventModel[]} event.context.eventRecords Event records being dragged
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.context.assignmentRecords Assignment records being dragged
     * @param {Scheduler.model.SchedulerEventModel} event.context.targetEventRecord The event record (if any) where the drop happened
     * @param {Scheduler.model.SchedulerResourceModel} event.context.newResource Resource record for drop target
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventEdit)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The scheduler
     * @param {Scheduler.feature.EventEdit} event.eventEdit The eventEdit feature
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventResizeFinalize)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Scheduler instance
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventSave)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The scheduler instance
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The record about to be saved
     * @param {Scheduler.model.SchedulerResourceModel[]} event.resourceRecords The resources to which the event is assigned
     * @param {object} event.values The new values
     ...
     */
    onBeforeEventSave? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, resourceRecords: SchedulerResourceModel[], values: object, context: { async?: boolean, finalize: Function } }) => Promise<boolean>|boolean|void)|string
    /**
     * Fired on the owning Scheduler before event segment dragging starts. Return `false` to prevent the action.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Scheduler instance
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords Segments to drag
     * @param {MouseEvent} event.event Browser event
     */
    onBeforeEventSegmentDrag? : ((event: { source: Scheduler, eventRecords: SchedulerEventModel[], event: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventSegmentDropFinalize)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Scheduler instance
     * @param {object} event.context
     ...
     * @param {Scheduler.model.SchedulerEventModel[]} event.context.eventRecords Dragged segments
     * @param {boolean} event.context.valid Set this to `false` to abort the drop immediately.
     * @param {Function} event.context.finalize Call this method after an <strong>async</strong> finalization flow, to finalize the drag-drop operation. This method accepts one argument: pass `true` to update records, or `false` to ignore changes
     */
     ...
     * `data.context.async = true` in the listener, to show a confirmation popup etc
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeEventSegmentResizeFinalize)
     * @param {object} event Event object
     * @param {SchedulerPro.view.SchedulerPro} event.source Scheduler Pro instance
     * @param {object} event.context
     ...
     * @param {object} event Event object
     * @param {string} event.action One of the actions 'select', 'deselect', 'update', 'clear'
     * @param {Scheduler.model.SchedulerEventModel[]} event.selected An array of events that will be added to the selection.
     * @param {Scheduler.model.SchedulerEventModel[]} event.deselected An array of events that will be removed from the selection.
     * @param {Scheduler.model.SchedulerEventModel[]} event.selection The currently selected events, before applying `selected` and `deselected`.
     */
    onBeforeEventSelectionChange? : ((event: { action: string, selected: SchedulerEventModel[], deselected: SchedulerEventModel[], selection: SchedulerEventModel[] }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeFinishRowEdit)
     * @param {object} event Event object
     * @param {Grid.view.Grid} event.grid Target grid
     * @param {RowEditorContext} event.editorContext Editing context
     */
    ...
    /**
     * Fires on the owning Scheduler when the CalendarHighlight feature has created highlighting items which are
     * about to be rendered.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source
     * @param {Scheduler.model.SchedulerEventModel[]} event.events The event records about to be rendered
     * @param {Scheduler.model.SchedulerResourceModel} event.resource The resource for the current highlighting items
     * @param {Scheduler.model.TimeSpan[]} event.highlights The highlighting items about to be rendered. It is supported to replace the value of this parameter with a new array instance.
     */
    onBeforeRenderCalendarHighlights? : ((event: { source: Scheduler, events: SchedulerEventModel[], resource: SchedulerResourceModel, highlights: TimeSpan[] }) => void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {SchedulerPro.view.ResourceGrid} event.source The grid instance
     * @param {SchedulerPro.feature.ResourceEdit} event.resourceEdit The resourceEdit feature
     * @param {SchedulerPro.model.SchedulerProResourceModel} event.resourceRecord The record about to be shown in the editor.
     */
    onBeforeResourceEdit? : ((event: { source: ResourceGrid, resourceEdit: ResourceEdit, resourceRecord: SchedulerProResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
     * This event fires before row collapse is started.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeRowCollapse)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeRowExpand)
     * @param {object} event Event object
     * @param {Core.data.Model} event.record Record
     */
     ...
     * The event is triggered only when [multiSelect](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScheduleContext#config-multiSelect) is enabled
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeSelectedContextsShow)
     * @param {object} event Event object
     * @param {Scheduler.feature.ScheduleContext} event.source The ScheduleContext feature instance
     ...
     * @param {DomConfig} event.domConfig A [DomConfig](https://bryntum.com/products/gantt/docs/api/Core/helper/DomHelper#typedef-DomConfig) config object which is used to render the selected cell elements.
     */
    onBeforeSelectedContextsShow? : ((event: { source: ScheduleContext, selectedContexts: TimelineContext[], domConfig: DomConfig }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onBeforeStateApply? : ((event: { state: SchedulerStateInfo }) => Promise<boolean>|boolean|void)|string
    /**
     * Fired before state is saved by the StateProvider. Allows editing the state object or preventing the operation.
     * @param {object} event Event object
     * @param {SchedulerStateInfo} event.state State object config
     */
    onBeforeStateSave? : ((event: { state: SchedulerStateInfo }) => Promise<boolean>|boolean|void)|string
    /**
     * Fires on the owning Scheduler or Gantt widget before a task is deleted, return `false` to prevent it.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeTaskDelete)
     * @param {object} event Event object
     * @param {SchedulerPro.view.SchedulerPro} event.source The Scheduler Pro instance.
     ...
     * stops the default editing UI from being shown.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeTaskEdit)
     * @param {object} event Event object
     * @param {SchedulerPro.view.SchedulerPro} event.source The Scheduler Pro instance
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-beforeTaskSave)
     * @param {object} event Event object
     * @param {SchedulerPro.view.SchedulerPro} event.source The Scheduler Pro instance
     * @param {SchedulerPro.model.EventModel} event.taskRecord The task about to be saved
     * @param {SchedulerPro.widget.TaskEditorBase} event.editor The editor widget
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-catchAll)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-cellMenuBeforeShow)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-dateRangeChange)
     * @param {object} event Event object
     ...
     * @param {Scheduler.view.Scheduler} event.source
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     * @param {Scheduler.model.SchedulerDependencyModel} event.dependencyRecord Dependency record for which the menu was triggered
     * @param {HTMLElement} event.element
     * @param {MouseEvent} event.event Pointer event which triggered the context menu (if any)
     */
    onDependencyMenuBeforeShow? : ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, dependencyRecord: SchedulerDependencyModel, element: HTMLElement, event?: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onDependencyMenuItem? : ((event: { source: Scheduler, dependencyRecord: SchedulerDependencyModel, item: MenuItem, element: HTMLElement }) => void)|string
    /**
     ...
     * @param {HTMLElement} event.element The dependency element
     */
    onDependencyMenuShow? : ((event: { source: Scheduler, menu: Menu, dependencyRecord: SchedulerDependencyModel, element: HTMLElement }) => void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The new `EventModel` record.
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource for the row in which the event is being created.
     ...
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The new event record.
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource assigned to the new event.
     */
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord Event record
     * @param {Scheduler.model.SchedulerAssignmentModel} event.assignmentRecord Assignment record
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventClick? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventContextMenu? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventDblClick? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord Resource record the drag started from
     * @param {Scheduler.model.SchedulerResourceModel} event.newResource Resource at the current location
     * @param {object} event.context
     ...
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.selectedAssignments The selected assignments
     * @param {Scheduler.model.SchedulerEventModel[]} event.selectedEvents The selected events
     */
    onEventDragSelect? : ((event: { source: SchedulerBase, startDate: Date, endDate: Date, rectangle: Rectangle, selectedAssignments: SchedulerAssignmentModel[], selectedEvents: SchedulerEventModel[] }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onEventDragStart? : ((event: { source: Scheduler, resourceRecord: SchedulerResourceModel, eventRecords: SchedulerEventModel[], assignmentRecords: SchedulerAssignmentModel[], domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {object} event.context
     * @param {Scheduler.model.SchedulerEventModel} event.context.targetEventRecord Event record for drop target
     * @param {Scheduler.model.SchedulerResourceModel} event.context.newResource Resource record for drop target
     * @param {MouseEvent} event.domEvent Browser event
     */
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords The selected event records
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.assignmentRecords The selected assignment records
     ...
     * @param {MouseEvent} event.event Pointer event which triggered the context menu (if any)
     */
    onEventMenuBeforeShow? : ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, eventRecord: SchedulerEventModel, resourceRecord: SchedulerResourceModel, assignmentRecord: SchedulerAssignmentModel, eventElement: HTMLElement, event?: MouseEvent }) => Promise<boolean>|boolean|void)|string
    /**
     * This event fires on the owning Scheduler when an item is selected in the context menu.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseDown? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseEnter? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseLeave? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     * Triggered for mouse out events within and when moving out of an event bar.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-eventMouseOut)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord Event record
     * @param {Scheduler.model.SchedulerAssignmentModel} event.assignmentRecord Assignment record
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseOut? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     * Triggered for mouse over events when moving into and within an event bar.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-eventMouseOver)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord Event record
     * @param {Scheduler.model.SchedulerAssignmentModel} event.assignmentRecord Assignment record
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseOver? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.event Browser event
     */
    onEventMouseUp? : ((event: { source: Scheduler, eventRecord: SchedulerEventModel, assignmentRecord: SchedulerAssignmentModel, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: SchedulerResourceModel, event: MouseEvent }) => void)|string
    /**
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Scheduler instance
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords Dragged segments
     * @param {Date} event.startDate Start date for the current location
     * @param {Date} event.endDate End date for the current location
     * @param {object} event.context
     * @param {boolean} event.context.valid Set this to `false` to signal that the current drop position is invalid.
     ...
     * @param {object} event Event object
     * @param {'select','deselect','update','clear'} event.action One of the actions 'select', 'deselect', 'update', 'clear'
     * @param {Scheduler.model.SchedulerEventModel[]} event.selected An array of the Events added to the selection.
     * @param {Scheduler.model.SchedulerEventModel[]} event.deselected An array of the Event removed from the selection.
     * @param {Scheduler.model.SchedulerEventModel[]} event.selection The new selection.
     */
     ...
     * Fires on the owning Grid before the row editing is finished, return false to signal that the value is invalid and editing should not be finalized.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-finishRowEdit)
     * @param {object} event Event object
     * @param {Grid.view.Grid} event.grid Target grid
     * @param {RowEditorContext} event.editorContext Editing context
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-headerClick)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-headerMenuBeforeShow)
     * @param {object} event Event object
     * @param {Grid.view.Grid} event.source The grid
     * @param {Core.widget.Menu} event.menu The menu
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-paint)
     * @param {object} event Event object
     ...
     * [singleAssignment](https://bryntum.com/products/gantt/docs/api/Scheduler/data/EventStore#config-singleAssignment) or the configuration of
     * [copyPasteAction](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventCopyPaste#config-copyPasteAction), either the `eventRecords` or the `assignmentRecords` param will be populated
     * with record copies.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source Owner scheduler
     * @param {Scheduler.model.SchedulerEventModel[]} event.eventRecords The event records about to be pasted
     * @param {Scheduler.model.SchedulerAssignmentModel[]} event.assignmentRecords The assignment records about to be pasted
     ...
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler
     * @param {Scheduler.model.SchedulerEventModel} event.eventRecord The event record
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource record
     * @param {Scheduler.model.SchedulerAssignmentModel} event.assignmentRecord The assignment record
     ...
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource record
     * @param {Scheduler.model.SchedulerAssignmentModel} event.assignmentRecord The assignment record
     * @param {object} event.renderData An object containing details about the event rendering, see [eventRenderer](https://bryntum.com/products/gantt/docs/api/Scheduler/view/mixin/SchedulerEventRendering#config-eventRenderer) for details
     ...
     * @param {object} event Event object
     * @param {SchedulerPro.widget.ResourceEditor} event.source The editor widget
     * @param {SchedulerPro.model.SchedulerProResourceModel} event.resource The resource
     */
    onResourceEditBeforeRemove? : ((event: { source: ResourceEditor, resource: SchedulerProResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {SchedulerPro.model.SchedulerProResourceModel} event.resource The resource
     */
    onResourceEditBeforeSave? : ((event: { source: ResourceEditor, resource: SchedulerProResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {SchedulerPro.model.SchedulerProResourceModel} event.resource The resource
     */
    onResourceEditRemove? : ((event: { source: ResourceEditor, resource: SchedulerProResourceModel }) => void)|string
    /**
     * Fires after the resource editor saves changes to a resource.
     * @param {object} event Event object
     * @param {SchedulerPro.widget.ResourceEditor} event.source The editor widget
     * @param {SchedulerPro.model.SchedulerProResourceModel} event.resource The resource
     * @param {Record<string, any>} event.values The changes
     */
    onResourceEditSave? : ((event: { source: ResourceEditor, resource: SchedulerProResourceModel, values: Record<string, any> }) => void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-resourceMenuBeforeShow)
     * @param {object} event Event object
     ...
     */
    onResourceMenuBeforeShow? : ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, column: Column, resourceRecord: SchedulerResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
     * This event fires on the owning scheduler when an item is selected in the context menu.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The grid
     ...
     * @param {Scheduler.model.SchedulerResourceModel} event.record Record
     */
    onResourceMenuShow? : ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, record: SchedulerResourceModel }) => void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-rowExpand)
     * @param {object} event Event object
     * @param {Core.data.Model} event.record Record
     ...
     * @param {HTMLElement} event.eventElement
     */
    onScheduleMenuBeforeShow? : ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, resourceRecord: SchedulerResourceModel, date: Date, assignmentRecord: SchedulerAssignmentModel, eventElement: HTMLElement }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     */
    onScheduleMenuShow? : ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, menu: Menu, resourceRecord: SchedulerResourceModel, date: Date, targetElement: HTMLElement }) => void)|string
    /**
     ...
     * @param {Scheduler.model.SchedulerResourceModel} event.resourceRecord The resource record
     */
    onScrollButtonClick? : ((event: { domEvent: Event, resourceRecord: SchedulerResourceModel }) => Promise<boolean>|boolean|void)|string
    /**
    ...
    /**
     * Fired when the [shiftIncrement](https://bryntum.com/products/gantt/docs/api/Scheduler/view/SchedulerBase#property-shiftIncrement) of this view changes.
     ...
     */
    onShiftIncrementChange? : ((event: { source: TimelineBase, old?: object, new: object }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onTickCellClick? : ((event: { source: Scheduler, feature: TreeSummary, startDate: Date, endDate: Date, resourceRecord: SchedulerResourceModel, domEvent: MouseEvent }) => void)|string
    /**
     * Triggered for right-click on a tick cell. Only triggered if the TreeSummary feature is configured
     * with `[enableMouseEvents](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/TreeSummary#config-enableMouseEvents): true`.
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler
     * @param {Scheduler.feature.TreeSummary} event.feature The TreeSummary feature
     * @param {Date} event.startDate Tick start date
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onTickCellContextMenu? : ((event: { source: Scheduler, feature: TreeSummary, startDate: Date, endDate: Date, resourceRecord: SchedulerResourceModel, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onTickCellDblClick? : ((event: { source: Scheduler, feature: TreeSummary, startDate: Date, endDate: Date, resourceRecord: SchedulerResourceModel, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onTickCellMouseDown? : ((event: { source: Scheduler, feature: TreeSummary, startDate: Date, endDate: Date, resourceRecord: SchedulerResourceModel, domEvent: MouseEvent }) => void)|string
    /**
     ...
     * @param {MouseEvent} event.domEvent Browser event
     */
    onTickCellMouseUp? : ((event: { source: Scheduler, feature: TreeSummary, startDate: Date, endDate: Date, resourceRecord: SchedulerResourceModel, domEvent: MouseEvent }) => void)|string
    /**
     * Fired when the tick size changes.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-tickSizeChange)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler instance.
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-timeAxisHeaderMenuBeforeShow)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The scheduler
     * @param {Core.widget.Menu} event.menu The menu
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     ...
     */
    onTimeAxisHeaderMenuBeforeShow? : ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, column: Column }) => Promise<boolean>|boolean|void)|string
    /**
     ...
     * @param {Grid.column.Column} event.column Time axis column
     */
    onTimeAxisHeaderMenuShow? : ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, column: Column }) => void)|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-transactionChange)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/view/SchedulerProBase#event-visibleDateRangeChange)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler instance.
     * @param {object} event.old The old date range
     * @param {Date} event.old.startDate the old start date.
    ...
    /**
     * This feature temporarily visualizes [calendars](https://bryntum.com/products/gantt/docs/api/SchedulerPro/model/CalendarModel) for the event or resource
     * calendar (controlled by the [calendar](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/CalendarHighlight#config-calendar) config). The calendars are highlighted while a user is creating,
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/CalendarHighlight)
     */
    ...
    /**
     * This feature implements support for project transactions and is used by default in Scheduler Pro. For
     * documentation about this feature, see [Dependencies](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/Dependencies).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/Dependencies)
     */
    dependenciesFeature? : object|boolean|string|SchedulerProDependencies|SchedulerProDependenciesConfig
    /**
     ...
     * application code.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/DependencyMenu)
     */
     ...
     * intervals should be considered busy time or available time using [bufferIsUnavailableTime](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/EventBuffer#property-bufferIsUnavailableTime).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/EventBuffer)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventDrag)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventDragCreate)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventDragSelect)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventEdit)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventMenu)
     */
     ...
     * SchedulerPro):
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/EventNonWorkingTime)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/EventResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/EventSegmentDrag)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/EventSegmentResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/experimental/ExcelExporter)
     */
    ...
    /**
     * Displays labels at positions [top](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/Labels#config-top), [right](#Scheduler/feature/Labels#config-right), [bottom](#Scheduler/feature/Labels#config-bottom) and
     * [left](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/Labels#config-left).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/Labels)
     */
    labelsFeature? : object|boolean|string|SchedulerLabels|SchedulerLabelsConfig
    /**
     * This feature allows resources which satisfy a certain condition to be locked at the top of the scheduler.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/LockRows)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/NestedEvents)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/export/PdfExport)
     */
    pdfExportFeature? : object|boolean|string|SchedulerPdfExport|SchedulerPdfExportConfig
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/export/Print)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/ResourceEdit)
     */
     ...
     * field of the record is updated (when [applyToAllRows](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/RowResize#config-applyToAllRows) is `false`) and the [eventLayout](#Scheduler/model/ResourceModel#field-eventLayout) of the dragged resource
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/RowResize)
     */
    rowResizeFeature? : object|boolean|string|RowResize|RowResizeConfig
    /**
     * Allow visually selecting a schedule "cell" by clicking, or [any other pointer gesture](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScheduleContext#config-triggerEvent).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScheduleContext)
     */
     ...
     * [labelRenderer](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScrollButtons#config-labelRenderer). Only supported in horizontal [mode](#Scheduler/view/SchedulerBase#config-mode)
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/ScrollButtons)
     */
    scrollButtonsFeature? : object|boolean|string|SchedulerScrollButtons|SchedulerScrollButtonsConfig
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/SimpleEventEdit)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/StickyEvents)
     */
    ...
    /**
     * Feature that displays a [Task editor](https://bryntum.com/products/gantt/docs/api/SchedulerPro/widget/SchedulerTaskEditor), allowing users to edit task data.
     * The Task editor is a popup containing tabs with fields for editing task data.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/TaskEdit)
     */
    taskEditFeature? : object|boolean|string|SchedulerProTaskEdit|SchedulerProTaskEditConfig
    /**
     ...
     * a [timeSelectionChange](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/TimeSelection#event-timeSelectionChange) event is fired.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/TimeSelection)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/feature/TreeSummary)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/SchedulerPro/feature/Versions)
     */
    versionsFeature? : object|boolean|string|SchedulerProVersions|SchedulerProVersionsConfig

}

export class BryntumSchedulerProBase extends React.Component<BryntumSchedulerProBaseProps> {

    static instanceClass = SchedulerProBase;

    static instanceName = 'SchedulerProBase';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumSchedulerProBaseProps>, nextState: Readonly<{}>): boolean {
