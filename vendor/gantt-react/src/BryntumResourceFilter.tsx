...
import { AlignSpec, Base, Collection, CollectionConfig, DomConfig, Field, KeyMapConfig, List, MaskConfig, Model, ModelConfig, Rectangle, ResourceFilter, ResourceFilterListeners, SchedulerEventStore, SchedulerResourceModel, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export type BryntumResourceFilterProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-align)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-cls)
     */
    cls? : string|object
    /**
     ...
     * `style` block.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-color)
     */
    color? : string
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-draggable)
     */
    draggable? : boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-elementAttributes)
     */
    ...
    emptyText? : string
    /**
     * The [EventStore](https://bryntum.com/products/gantt/docs/api/Scheduler/data/EventStore) to filter.
     * Events for resources which are deselected in this List will be filtered out.
     */
    eventStore? : SchedulerEventStore
    extraData? : any
    /**
     * By default, deselecting list items filters only the [eventStore](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-eventStore) so that
     * events for the deselected resources are hidden from view. The `resourceStore` is <strong>not</strong>
     * filtered.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-filterResources)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-hideAnimation)
     */
    hideAnimation? : boolean|object
    /**
     * The HTML to display initially or a function returning the markup (called at widget construction time).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-html)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-ignoreParentReadOnly)
     */
     ...
     * List's [store](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-store)
     */
    items? : object[]
    /**
     * Template function (or name of a template function), which, when passed a record, returns the textual HTML for
     * that item. Defaults to a function returning the value of the record´s [displayField](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-displayField)
     * @param {Core.data.Model} record The record
     * @returns {string}
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-keyMap)
     */
    keyMap? : Record<string, KeyMapConfig>
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-localizableProperties)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-masterFilter)
     * @param {Scheduler.model.SchedulerResourceModel} resource Resorce for filtering
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-positioned)
     */
    positioned? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-readOnly)
     */
    readOnly? : boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-rtl)
     */
    rtl? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-scrollable)
     */
     ...
     * Only applies when [multiSelect](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-multiSelect) mode is enabled.
     */
    selectAllItem? : boolean|string
    /**
     * A [Collection](https://bryntum.com/products/gantt/docs/api/Core/util/Collection), or Collection config object to use to contain this List's selected
     * records.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-selected)
     */
    selected? : object[]|number[]|string[]|Collection|CollectionConfig|CollectionConfig[]
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-showAnimation)
     */
    ...
    span? : number
    /**
     * A [Store](https://bryntum.com/products/gantt/docs/api/Core/data/Store) which provides the records which map to List items. Each record is passed through the
     * [itemTpl](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-itemTpl) to produce the DOM structure of the List. May be generated from an array of [items](#Core/widget/List#config-items).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-store)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-tooltip)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-ui)
     */
    ui? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-x)
     */
    x? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#config-y)
     */
    y? : number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#event-catchAll)
     * @param {object} event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/widget/ResourceFilter#event-paint)
     * @param {object} event Event object
