...
export class BryntumCalendarPicker extends React.Component<BryntumCalendarPickerProps> {

    static instanceClass = CalendarPicker;

    static instanceName = 'CalendarPicker';
    ...
    render(): React.ReactNode {
        ...
        const className = `b-react-calendar-picker-container`;
        return (
