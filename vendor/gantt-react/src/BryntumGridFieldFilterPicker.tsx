...
import { AlignSpec, Base, CollectionFilter, CollectionFilterConfig, ComboConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FieldFilterPicker, FieldOption, Grid, GridFieldFilterPicker, GridFieldFilterPickerListeners, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolbarItems, TooltipConfig, ValueFieldPlaceholders, VueConfig, Widget } from '@bryntum/gantt';
...
export type BryntumGridFieldFilterPickerProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-align)
     */
     ...
     * This is a subset of the field names found in the [grid](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-grid)'s columns. When supplied, only
     * the named fields will be shown in the property selector combo.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-allowedFieldNames)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-cls)
     */
    cls? : string|object
    /**
     ...
     * `style` block.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-color)
     */
    color? : string
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-defaultFocus)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-draggable)
     */
    draggable? : boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-elementAttributes)
     */
     ...
     * keyed by field name.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-fields)
     */
    fields? : Record<string, FieldOption>
    /**
     * Configuration object for the [CollectionFilter](https://bryntum.com/products/gantt/docs/api/Core/util/CollectionFilter) displayed
     * and editable in this picker.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-filter)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-getValueFieldConfig)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-grid)
     */
    grid? : Grid
    /**
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-hideAnimation)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-hideWhenEmpty)
     */
    hideWhenEmpty? : boolean
    /**
     * The HTML to display initially or a function returning the markup (called at widget construction time).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-html)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-inputFieldAlign)
     */
     ...
     * as an array.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-items)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-keyMap)
     */
    keyMap? : Record<string, KeyMapConfig>
    /**
     * Convenience setting to use same label placement on all child widgets.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-labelPosition)
     */
    labelPosition? : 'before'|'above'|'align-before'|'auto'|null
    /**
     * The short name of a helper class which manages rendering and styling of child items.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-layout)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-layoutStyle)
     */
    layoutStyle? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-lazyItems)
     */
    lazyItems? : Record<string, ContainerItemConfig>|ContainerItemConfig[]|Widget[]
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-namedItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-operators)
     */
    operators? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-positioned)
     */
    positioned? : boolean
    /**
    ...
    /**
     * Optional configuration for the property selector [Combo](https://bryntum.com/products/gantt/docs/api/Core/widget/Combo).
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-record)
     */
    record? : Model
     ...
     * `type`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-rendition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-rtl)
     */
    rtl? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-scrollable)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-tabBarItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-textContent)
     */
    textContent? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-tooltip)
     */
    tooltip? : string|TooltipConfig|null
    /**
     * Whether to raise [change](https://bryntum.com/products/gantt/docs/api/Core/widget/FieldFilterPicker#event-change) events as the user types into a value field. If `false`,
     * [change](https://bryntum.com/products/gantt/docs/api/Core/widget/FieldFilterPicker#event-change) events will be raised only when the value input field's own `change` event
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-ui)
     */
    ui? : string|object
    /**
     * Optional [ValueFieldPlaceholders](https://bryntum.com/products/gantt/docs/api/Core/widget/FieldFilterPicker#typedef-ValueFieldPlaceholders) object specifying custom placeholder text for value input fields.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-x)
     */
    x? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#config-y)
     */
    y? : number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#event-catchAll)
     * @param {object} event Event object
     ...
     * @param {any[]} event.filter The [CollectionFilter](https://bryntum.com/products/gantt/docs/api/Core/util/CollectionFilter) configuration object for the filter represented by this [FieldFilterPicker](https://bryntum.com/products/gantt/docs/api/Core/widget/FieldFilterPicker).
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GridFieldFilterPicker#event-paint)
     * @param {object} event Event object
