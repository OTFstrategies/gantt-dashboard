...
import { AIFilter, AIFilterConfig, AjaxStore, AjaxStoreConfig, Base, CellCopyPaste, CellCopyPasteConfig, CellEditorContext, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Charts, ChartsConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnLines, ColumnLinesConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ColumnStore, ColumnStoreConfig, Container, ContainerItemConfig, DomConfig, DurationUnit, EmptyTextDomConfig, EventColor, ExportConfig, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, FormulaProviderConfig, Grid, GridBase, GridCellEdit, GridCellEditConfig, GridColumnConfig, GridExcelExporter, GridExcelExporterConfig, GridLocation, GridLocationConfig, GridLockRows, GridLockRowsConfig, GridPdfExport, GridPdfExportConfig, GridPrint, GridPrintConfig, GridRowResize, GridRowResizeConfig, GridSelectionMode, GridStateInfo, GridTreeGroup, GridTreeGroupConfig, Group, GroupConfig, GroupSummary, GroupSummaryConfig, HeaderMenu, HeaderMenuConfig, HeaderZoom, HeaderZoomConfig, Histogram, HistogramConfig, HistogramRenderData, HistogramSeries, KeyMapConfig, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, NonWorkingTime, NonWorkingTimeConfig, PagingToolbarConfig, Pan, PanConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PinColumns, PinColumnsConfig, PreserveScrollOptions, PresetStore, QuickFind, QuickFindConfig, RecordPositionContext, RecurrenceConfirmationPopup, RecurrenceConfirmationPopupConfig, RegionResize, RegionResizeConfig, ResourceMenu, ResourceMenuConfig, ResourceTimeRangeModel, ResourceTimeRanges, ResourceTimeRangesConfig, Row, RowCopyPaste, RowCopyPasteConfig, RowEdit, RowEditConfig, RowEditorContext, RowExpander, RowExpanderConfig, RowReorder, RowReorderConfig, ScaleColumnConfig, ScalePoint, ScheduleTooltip, ScheduleTooltipConfig, Scheduler, SchedulerAssignmentModel, SchedulerEventModel, SchedulerResourceModel, SchedulerSummary, SchedulerSummaryConfig, SchedulerTimeAxisColumn, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, Sort, SortConfig, Split, SplitConfig, StateProvider, StickyCells, StickyCellsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, TabConfig, TimeAxis, TimeAxisConfig, TimeAxisHeaderMenu, TimeAxisHeaderMenuConfig, TimeRanges, TimeRangesConfig, TimeSpan, TimelineBase, TimelineContext, TimelineHistogram, TimelineHistogramListeners, TimelineStateInfo, Tool, ToolConfig, ToolbarConfig, ToolbarItems, Tooltip, TooltipConfig, Tree, TreeConfig, VerticalTimeAxisColumn, ViewPreset, ViewPresetConfig, VisibleDate, Widget, XLSColumn } from '@bryntum/gantt';
...
export type BryntumTimelineHistogramProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * A function used for aggregating child records histogram data entries to their parent entry.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-aggregateDataEntry)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-barMargin)
     */
    barMargin? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-bbar)
     */
    bbar? : (ContainerItemConfig|string)[]|ToolbarConfig|PagingToolbarConfig|null
    /**
     * Custom CSS classes to add to the panel's body element.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-bodyCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-bufferCoef)
     */
    bufferCoef? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-bufferThreshold)
     */
    bufferThreshold? : number
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-cls)
     */
    cls? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-collapsible)
     */
     ...
     * `style` block.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-color)
     */
    color? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-columns)
     */
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-data)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-dataModelField)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-displayDateFormat)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-dock)
     */
    dock? : 'top'|'bottom'|'left'|'right'|'start'|'end'|'header'|'pre-header'|object
    /**
     * Make this Panel a docked drawer which slides out from one side of the browser viewport by default.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-drawer)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-elementAttributes)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-emptyText)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-enableRecurringEvents)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-enableSticky)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-endDate)
     */
    endDate? : Date|string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-eventColor)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-eventStyle)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-fillTicks)
     */
    fillTicks? : boolean
    /**
     ...
     * performance.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-fixedRowHeight)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-footer)
     */
    footer? : {
     ...
     * `formula : true`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-formulaProviders)
     */
    formulaProviders? : Record<string, FormulaProviderConfig>
    /**
     * Refresh entire row when a record changes (`true`) or, if possible, only the cells affected (`false`).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-fullRowRefresh)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getBarDOMConfig)
     * @param {HistogramSeries} series The series being rendered
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getBarText)
     * @param {object} datum The datum being rendered
     * @param {number} index The index of the datum being rendered
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getBarTextDOMConfig)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getDataEntryForAggregating)
     ...
     * in an argument which then can be processed and returned.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getOutlineDOMConfig)
     * @param {HistogramSeries} series The series being rendered
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getRecordData)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-getRowHeight)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-header)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-hideRowHover)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-infiniteScroll)
     */
    infiniteScroll? : boolean
    /**
     * A function that initializes a target group record entry.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-initAggregatedDataEntry)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-inputFieldAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-labelPosition)
     */
    labelPosition? : 'before'|'above'|'align-before'|'auto'|null
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-listeners)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-loadMaskDefaults)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-loadMaskError)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-managedEventSizing)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-maxTimeAxisUnit)
     */
     ...
     * inserted.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-minHeight)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-partner)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-presets)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-readOnly)
     */
    readOnly? : boolean
    /**
     * The confirmation dialog shown when a recurring event is edited.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-recurrenceConfirmationPopup)
     */
     ...
     * `type`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-rendition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-resizable)
     */
    resizable? : boolean|{
        minWidth?: number
        maxWidth?: number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-resourceTimeRangeRenderer)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-rtl)
     */
    rtl? : boolean
    /**
     * An object with configuration for the [ScaleColumn](https://bryntum.com/products/gantt/docs/api/Scheduler/column/ScaleColumn).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-scaleColumn)
     */
     ...
     * config.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-scalePoints)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-scrollable)
     */
     ...
     * selected.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-selectionMode)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-series)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-showDirty)
     */
    showDirty? : boolean|{
        duringEdit?: boolean
        newRecord?: boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-snap)
     */
    snap? : boolean
    /**
     ...
     * is enabled.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-snapRelativeToEventStartDate)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-startDate)
     */
    startDate? : Date|string
    /**
     * This value can be one of the following:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-stateful)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-statefulEvents)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-stateId)
     */
    stateId? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-stateProvider)
     */
    stateProvider? : StateProvider
    /**
     * The properties of this settings object controls how grid is restored from state data.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-stateSettings)
     */
    stateSettings? : {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-store)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-strips)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-subGridConfigs)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-syncMask)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-tabBarItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-tbar)
     */
    tbar? : (ContainerItemConfig|string)[]|ToolbarConfig|PagingToolbarConfig|null
    /**
     * The width/height (depending on vertical / horizontal mode) of all the time columns.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-tickSize)
     */
    tickSize? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-timeResolution)
     */
    timeResolution? : {
        increment?: number
        unit?: DurationUnit
     ...
     * information.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-timeZone)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-title)
     */
    title? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-tools)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-ui)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-viewPreset)
     */
    viewPreset? : string|ViewPresetConfig
    /**
     * A date to bring into view initially on the scrollable timeline.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-visibleDate)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#config-workingTime)
     */
    workingTime? : {
        fromDay?: number
        toDay?: number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeAssignmentDelete)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeCancelRowEdit)
     * @param {object} event Event object
     ...
     * for async vetoing).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeEventDelete)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeFinishRowEdit)
     * @param {object} event Event object
     * @param {Grid.view.Grid} event.grid Target grid
     * @param {RowEditorContext} event.editorContext Editing context
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeHistogramDataCacheSet)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeRenderHistogramRow)
     * @param {object} event Event object
     * @param {Scheduler.view.TimelineHistogram} event.source The component instance
     * @param {Core.data.Model} event.record Record the histogram data of which is ready.
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeRowCollapse)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-beforeRowExpand)
     * @param {object} event Event object
     * @param {Core.data.Model} event.record Record
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-catchAll)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-cellMenuBeforeShow)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-dateRangeChange)
     * @param {object} event Event object
     ...
     * Fires on the owning Grid before the row editing is finished, return false to signal that the value is invalid and editing should not be finalized.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-finishRowEdit)
     * @param {object} event Event object
     * @param {Grid.view.Grid} event.grid Target grid
     * @param {RowEditorContext} event.editorContext Editing context
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-headerClick)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-headerMenuBeforeShow)
     * @param {object} event Event object
     * @param {Grid.view.Grid} event.source The grid
     * @param {Core.widget.Menu} event.menu The menu
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     ...
     * it into the cache.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-histogramDataCacheSet)
     * @param {object} event Event object
     * @param {Scheduler.view.TimelineHistogram} event.source The component instance
     * @param {Core.data.Model} event.record Record the histogram data of which is ready.
     * @param {object} event.data The record histogram data.
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-paint)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-resourceMenuBeforeShow)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-rowExpand)
     * @param {object} event Event object
     * @param {Core.data.Model} event.record Record
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-tickSizeChange)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler instance.
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-timeAxisHeaderMenuBeforeShow)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source The scheduler
     * @param {Core.widget.Menu} event.menu The menu
     * @param {Record<string, MenuItemConfig>} event.items Menu item configs
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Scheduler/view/TimelineHistogram#event-visibleDateRangeChange)
     * @param {object} event Event object
     * @param {Scheduler.view.Scheduler} event.source This Scheduler instance.
     * @param {object} event.old The old date range
     * @param {Date} event.old.startDate the old start date.
