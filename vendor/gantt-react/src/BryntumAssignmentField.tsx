...
import { AlignSpec, AssignmentField, AssignmentFieldListeners, AssignmentGrid, AssignmentGridConfig, AssignmentModel, Base, ChipViewConfig, CollectionCompareOperator, CollectionFilterConfig, Combo, ComboModel, ContainerItemConfig, DomConfig, Duration, DurationConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, List, ListConfig, MaskConfig, Model, Rectangle, Scroller, Store, StoreConfig, TabConfig, TaskModel, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export class BryntumAssignmentField extends React.Component<BryntumAssignmentFieldProps> {

    static instanceClass = AssignmentField;

    static instanceName = 'AssignmentField';
