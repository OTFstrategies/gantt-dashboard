/**
 * React wrapper for Bryntum FilterField
 */
...
export type BryntumFilterFieldProps = {
    // Configs
    /**
     * Element (or element id) to adopt as this Widget's encapsulating element. The widget's
     * content will be placed inside this element.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-align)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-cls)
     */
    cls? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-container)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-containValues)
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-draggable)
     */
    draggable? : boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-editable)
     */
    editable? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-elementAttributes)
     */
    elementAttributes? : Record<string, string|null>
    extraData? : any
    /**
     * The model field name to filter by. Can optionally be replaced by [filterFunction](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-filterFunction)
     */
    field? : string
    /**
     * Optional filter function to be called with record and value as parameters for store filtering.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-filterFunction)
     ...
     * This applies to a passed [filterFunction](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-filterFunction) as well as for an internally generated filter.
     * If no value is configured, an internal ID will be generated.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-filterId)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-hideAnimation)
     */
     ...
     * a field's units.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-hint)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-hintHtml)
     * @param {object} data A data object
     * @param {Core.widget.Field} data.source A reference to the field instance
     * @param {any} data.value The current value of the field
     * @returns {string}
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-inline)
     */
    inline? : boolean
    /**
    ...
    /**
     * Set this flag to mark the filter as `internal` when adding it to the associated [Store](https://bryntum.com/products/gantt/docs/api/Core/data/Store).
     * This prevents the filter from being removed when [Store.clearFilters()](https://bryntum.com/products/gantt/docs/api/Core/data/Store#function-clearFilters)
     * is called.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-keyMap)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-keyStrokeChangeDelay)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-labelPosition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-labels)
     */
    labels? : object[]
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-name)
     */
    name? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-positioned)
     */
    positioned? : boolean
    /**
     ...
     * are unresponsive.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-readOnly)
     */
    readOnly? : boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-rendition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-rtl)
     */
    rtl? : boolean
    /**
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-tabIndex)
     */
    tabIndex? : number
    /**
     * Text alignment: 'left', 'center' or 'right'. Also accepts direction neutral 'start' and 'end'.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-tooltip)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-triggers)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-ui)
     */
    ui? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-x)
     */
    x? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#config-y)
     */
    y? : number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#event-catchAll)
     * @param {object} event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#event-clear)
     * @param {object} event Event object
     * @param {Core.widget.Field,any} event.source This Field
     */
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/FilterField#event-paint)
     * @param {object} event Event object
...
export class BryntumFilterField extends React.Component<BryntumFilterFieldProps> {

    static instanceClass = FilterField;

    static instanceName = 'FilterField';
     ...
     * @returns {boolean}
     */
    shouldComponentUpdate(nextProps: Readonly<BryntumFilterFieldProps>, nextState: Readonly<{}>): boolean {
