...
import { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, Editor, EditorListeners, InputFieldConfig, KeyMapConfig, Layout, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export type BryntumEditorProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * The alignment config for how this editor aligns to a target when asked to [startEdit](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#function-startEdit)
     */
    align? : AlignSpec
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-callOnFunctions)
     */
    callOnFunctions? : boolean
    /**
     * The name of the `key` which cancels the edit.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-cancelKey)
     */
    cancelKey? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-catchEventHandlerExceptions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-cls)
     */
    cls? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-completeKey)
     */
    completeKey? : string
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-defaultFocus)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-draggable)
     */
    draggable? : boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-elementAttributes)
     */
    elementAttributes? : Record<string, string|null>
    extraData? : any
    /**
     * Controls whether the editor should expand its width if the input field has overflow [startEdit](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#function-startEdit)
     */
     ...
     * bottom of the cell. This will also default [scrollAction](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-scrollAction) to `realign` and
     * [matchSize](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-matchSize) to `false`. It is also recommended to set a `minHeight` and/or `minWidth` property
     * on the [align](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-align) config.
     */
    floating? : boolean
    /**
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-hideAnimation)
     */
    hideAnimation? : boolean|object
    /**
     * Controls whether to hide the target element when asked to [startEdit](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#function-startEdit)
     */
    hideTarget? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-hideWhenEmpty)
     */
    hideWhenEmpty? : boolean
    /**
     * The HTML to display initially or a function returning the markup (called at widget construction time).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-html)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-ignoreParentReadOnly)
     */
    ignoreParentReadOnly? : boolean
    /**
     * A config object, or the `type` string of the widget (usually a [Field](https://bryntum.com/products/gantt/docs/api/Core/widget/Field) subclass,
     * i.e. [TextField](https://bryntum.com/products/gantt/docs/api/Core/widget/TextField)) which this editor will encapsulate.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-inputFieldAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-invalidAction)
     */
     ...
     * as an array.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-items)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-keyMap)
     */
    keyMap? : Record<string, KeyMapConfig>
    /**
     * Convenience setting to use same label placement on all child widgets.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-labelPosition)
     */
    labelPosition? : 'before'|'above'|'align-before'|'auto'|null
    /**
     * The short name of a helper class which manages rendering and styling of child items.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-layout)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-layoutStyle)
     */
    layoutStyle? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-lazyItems)
     */
    lazyItems? : Record<string, ContainerItemConfig>|ContainerItemConfig[]|Widget[]
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-localizableProperties)
     */
    ...
    /**
     * Controls whether the editor should match target element's font when asked to [startEdit](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#function-startEdit)
     */
    matchFont? : boolean
    /**
     * By default, an Editor matches both dimensions, width and height of the element it is targeted at in the
     * [startEdit](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#function-startEdit) function.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-matchSize)
     */
    matchSize? : boolean|{
        width?: boolean
        height?: boolean
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-namedItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-positioned)
     */
    positioned? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-readOnly)
     */
    readOnly? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-record)
     */
    record? : Model
     ...
     * `type`.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-rendition)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-rtl)
     */
    rtl? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-scrollable)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-tabBarItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-textContent)
     */
    textContent? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-tooltip)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-ui)
     */
    ui? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-x)
     */
    x? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-y)
     */
    y? : number
     ...
     * @param {boolean,object} event.matchSize Whether to match the target size. See [matchSize](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-matchSize)
     * @param {boolean} event.matchSize.width Match width
     * @param {boolean} event.matchSize.height Match height
     * @param {boolean} event.matchFont Whether to match the target's font. See [matchFont](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#config-matchFont)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#event-catchAll)
     * @param {object} event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Core/widget/Editor#event-paint)
     * @param {object} event Event object
