...
import { AlignSpec, Base, Collection, CollectionConfig, DomConfig, GroupBar, GroupBarListeners, KeyMapConfig, List, MaskConfig, Model, ModelConfig, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, VueConfig, Widget } from '@bryntum/gantt';
...
export type BryntumGroupBarProps = {
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-adopt)
     */
    adopt? : HTMLElement|string
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-align)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-ariaLabel)
     */
    ariaLabel? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-bubbleEvents)
     */
    bubbleEvents? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-catchEventHandlerExceptions)
     */
    ...
    /**
     * Configure as `true` to display a clickable close icon after the [itemTpl](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-itemTpl).
     * When tapped, the configured [closeHandler](https://bryntum.com/products/gantt/docs/api/Core/widget/ChipView#config-closeHandler) is called passing the associated record.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-closable)
     */
    closable? : boolean
    /**
     * If [closable](https://bryntum.com/products/gantt/docs/api/Core/widget/ChipView#config-closable) is `true`, this is the name of a callback function to handle what the "close"
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-cls)
     */
    cls? : string|object
    /**
     ...
     * `style` block.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-color)
     */
    color? : string
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-detectCSSCompatibilityIssues)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-draggable)
     */
    draggable? : boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-elementAttributes)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-hideAnimation)
     */
    hideAnimation? : boolean|object
    /**
     * The HTML to display initially or a function returning the markup (called at widget construction time).
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-html)
     ...
     * placed before the [itemTpl](https://bryntum.com/products/gantt/docs/api/Core/widget/List#config-itemTpl).
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-keyMap)
     */
    keyMap? : Record<string, KeyMapConfig>
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-owner)
     */
    owner? : Widget|any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-positioned)
     */
    positioned? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-readOnly)
     */
    readOnly? : boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-ripple)
     */
    ripple? : boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-rtl)
     */
    rtl? : boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-scrollable)
     */
     ...
     * records.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-selected)
     */
    selected? : object[]|number[]|string[]|Collection|CollectionConfig|CollectionConfig[]
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/gantt/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-showAnimation)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-store)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-tooltip)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-ui)
     */
    ui? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-x)
     */
    x? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#config-y)
     */
    y? : number
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#event-catchAll)
     * @param {object} event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/gantt/docs/api/Grid/widget/GroupBar#event-paint)
     * @param {object} event Event object
